...
import { Users, GraduationCap, UserCheck, Mail, Lock, User, Phone, IdCard, Shield, UserSquare } from 'lucide-react';
  ...
  const handleSubmit = (e) => {
    ...
    if (authMode === 'signin') {
      const foundUser = mockUsers.find(
        (u) => u.email === formData.email && u.password === formData.password && u.role === userRole
      );
      if (foundUser) {
        onLogin(foundUser);
      } else {
